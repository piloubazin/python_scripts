...
for num in subjects:
    ...
    mag = sorted(glob(in_dir+subject+'/'+session+'/anat/wb/source/'+subject+'*wb*part-mag_mprage.nii.gz'))
    phs = sorted(glob(in_dir+subject+'/'+session+'/anat/wb/source/'+subject+'*wb*part-ph_mprage.nii.gz'))
                                        
    if (len(mag)==5 and len(phs)==5):         
             
        print("process subject "+subject)

        res_dir = final_dir+subject+'/'+session+'/anat/wb/qmri/'    
        r1_final = res_dir+subject+'_'+session+'_acq-wb2_mod-r1hz_orient-std_brain.nii.gz'
        r2_final = res_dir+subject+'_'+session+'_acq-wb2_mod-r2hz_orient-std_brain.nii.gz'
        pd_final = res_dir+subject+'_'+session+'_acq-wb2_mod-qpd_orient-std_brain.nii.gz'
        qsm_final = res_dir+subject+'_'+session+'_acq-wb2_mod-qsm_orient-std_brain.nii.gz'
        mask_final = res_dir+subject+'_'+session+'_acq-wb2_mod-brainmask_orient-std_brain.nii.gz'
...
#        fg_file = out_dir+subject+'_'+session+'_acq-wb_mod-foreground.nii.gz'
...
#        finalmask_file = out_dir+subject+'_'+session+'_acq-wb_mod-brainmask.nii.gz'
...
#            nighres.io.save_volume(finalmask_file, finalmask)
        ...
        r1strip_file = out_dir+subject+'_'+session+'_acq-wb2_mod_r1hz_orient-std_brain.nii.gz'
        ...
        r2strip_file = out_dir+subject+'_'+session+'_acq-wb2_mod_r2hz_orient-std_brain.nii.gz'
        ...
        pdstrip_file = out_dir+subject+'_'+session+'_acq-wb2_mod_qpd_orient-std_brain.nii.gz'
        ...
        qsm_file = out_dir+subject+'_'+session+'_acq-wb2_mod_qsm_orient-std_brain.nii.gz'
