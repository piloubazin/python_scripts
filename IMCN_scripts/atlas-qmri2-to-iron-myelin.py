...
data_dir='/home/pilou/Projects/Ahead-Database/MNI05-Coregistration/'
out_dir = '/home/pilou/Projects/Ahead-Database/IronMyelin-mapping/'

targets = ['ahead_qmri2_mni09b_med','ahead_qmri2_mni09b_iqr']

for target in targets: 

    r1_target = glob.glob(data_dir+target+'*_r1map_n105.nii.gz')
    r2s_target = glob.glob(data_dir+target+'*_r2map_n105.nii.gz')
    qsm_target = glob.glob(data_dir+target+'*_qsmap_n105.nii.gz')
    qpd_target = glob.glob(data_dir+target+'*_pdmap_n105.nii.gz')
