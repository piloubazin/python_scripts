...
in_dir=main_dir+'data/leipzig/15636.fa/20230331/mpm/0p6/Results/'
ext_dir=main_dir+'data/leipzig/15636.fa/20230331/mpm/0p6/Results/Supplementary/'
ref_dir=main_dir+'data/amsterdam/traveling_phantom_7T/'
proc_dir=main_dir+'processing/15636.fa/mpm0p6/'
out_dir=main_dir+'derivatives/15636.fa/mpm0p6/'

atlas_dir = '/home/pilou/Projects/Massp-Priors/'


# MPM input names
mpm_qr1_file = in_dir+'meas_MID00043_pdw_kp_mtflash3d_v1s_0p6_20230331-094003_rec-loraksRsos_echo-1_mt-off_part-mag_R1.nii.gz'
mpm_qr2s_file = in_dir+'meas_MID00043_pdw_kp_mtflash3d_v1s_0p6_20230331-094003_rec-loraksRsos_echo-1_mt-off_part-mag_R2s_WLS1.nii.gz'
mpm_qpd_file = in_dir+'meas_MID00043_pdw_kp_mtflash3d_v1s_0p6_20230331-094003_rec-loraksRsos_echo-1_mt-off_part-mag_PD.nii.gz'

# helper files?
mpm_T1w_file = ext_dir+'meas_MID00043_pdw_kp_mtflash3d_v1s_0p6_20230331-094003_rec-loraksRsos_echo-1_mt-off_part-mag_T1w_WLS1fit_TEzero.nii.gz'
mpm_PDw_file = ext_dir+'meas_MID00043_pdw_kp_mtflash3d_v1s_0p6_20230331-094003_rec-loraksRsos_echo-1_mt-off_part-mag_PDw_WLS1fit_TEzero.nii.gz'
...
mpm_r1strip_file = proc_dir+'mpm0p6_r1_brain.nii.gz'
...
mpm_r2strip_file = proc_dir+'mpm0p6_r2s_brain.nii.gz'
...
mpm_pdstrip_file = proc_dir+'mpm0p6_pd_brain.nii.gz'
...
ants1 = nighres.registration.embedded_antspy_multi(
                            ...
                            smooth_mask=0.33,
                            ignore_affine=True, 
                            save_data=True, file_name='smpm0p6_coreg2atlas1',
                            output_dir=proc_dir)
...
ants2 = nighres.registration.embedded_antspy_multi(
                            ...
                            smooth_mask=0.33,
                            ignore_affine=True, 
                            save_data=True, file_name='mpm0p6_coreg2atlas2',
                            output_dir=proc_dir)
...
massp = nighres.parcellation.massp(target_images=[mpm_r1strip_file,mpm_r2strip_file,mpm_pdstrip_file],
                            ...
                            save_data=True, file_name='mpm0p6',
