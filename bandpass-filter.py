...
parser.add_argument('-lf', '--low', nargs='?', default=0.01, help='low frequency (default: 0.01 Hz)')
parser.add_argument('-hf', '--high', nargs='?', default=0.1, help='high frequency (default: 0.1 Hz)')
...
for imgfile in imgfiles:
	...
	outname = outdir+basename[0]+"_bpf."+'.'.join(basename[1:])
